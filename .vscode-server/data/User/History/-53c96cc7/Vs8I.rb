...
p database.execute("SELECT count(id), avg(milliseconds) FROM tracks")
p database.execute("SELECT * FROM tracks t JOIN genres g WHERE t.genre_id = g.id AND g.name = 'Jazz'")
