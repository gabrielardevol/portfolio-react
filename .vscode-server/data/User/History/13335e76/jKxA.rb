...
db.execute("INSERT INTO people (name, birth, birthplace, description)
  VALUES ('Lluís Llach', '1948', 'Girona', 'Músic, cantautor, escriptor i polític català.
    És precís entendre la seva oposició al règim franquista en relació a la seva orientació homosexual.')")
