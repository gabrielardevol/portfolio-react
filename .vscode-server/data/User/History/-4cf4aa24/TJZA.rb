...
# HidingGameController.new.wolf_blows(20, 3)

# HidingGameController.new.pigs_build(17)

HidingGameController.new(21).run_game(3)


# definir totxos i totxos-per-bufar
# em retorna totxos-restants
#
# 23 | 3
# 20 | 3
# 17 | 3
